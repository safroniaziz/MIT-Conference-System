    ...
    <div class="row">
        <div class="col-md-4 sm-6">
            <div class="box box-info">
                ...
                <h3 class="box-title"><i class="fa fa-user"></i>&nbsp;Profil Peserta</h3>
                </div>
        ...
        <div class="col-md-8 sm-6">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-info-circle"></i>&nbsp;Informasi Aplikasi</h3>
                </div>
                <div class="box-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-default">
                <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-history"></i>&nbsp;Riwayat Login</h3>
                </div>
                <div class="box-body">
