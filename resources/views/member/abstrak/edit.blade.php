...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    <form action="{{ route('member.abstrak.update',[$abstrak->id]) }}" enctype="multipart/form-data" method="POST">
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1">Judul Usulan</label>
                            <textarea name="judul" class="form-control" id="" cols="30" rows="5">{{ $abstrak->judul }}</textarea>
                            <div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="tahun_usulan" id="year" value="{{ $abstrak->tahun_usulan }}" class="form-control" required></select>
                            <div>
                        ...
                        <div class="form-group col-md-6">
                            <label for="">File Abstrak PDF | <small class="text-danger">File Lama : {{ $abstrak->file_abstrak }}</small></label>
                            <input type="file" name="file_abstrak" value="{{ $abstrak->file_abstrak }}" id="file_abstrak" class="form-control">
                            <div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="abstrak" id="abstrak" class="form-control" id="" cols="30" rows="10">{{ $abstrak->abstrak}}</textarea>
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <a href="{{ route('member.abstrak') }}" class="btn btn-warning btn-sm" style="color: white"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
